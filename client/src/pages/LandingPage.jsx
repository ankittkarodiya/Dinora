...
// ← NEW: small icon mark echoing the logo's ticket shape, used inline in the navbar
function LogoMark({ className = "w-8 h-8" }) {
  return (
    <svg viewBox="0 0 32 32" className={className}>
      <rect width="32" height="32" rx="8" fill="#1d1a17" />
      <text
        x="50%"
        y="55%"
        textAnchor="middle"
      ...
      <circle cx="22.5" cy="10.5" r="2" fill="#c1440e" />
    </svg>
  );
}
...
export default function LandingPage() {
  ...
  const [mobileNavOpen, setMobileNavOpen] = useState(false); // ← NEW: controls the mobile nav menu

  // ← NEW: smooth-scrolls to a section by id and closes the mobile menu afterward
  ...
  return (
    <div className="min-h-screen bg-[#1d1a17] font-body text-[#f6efe3] overflow-x-hidden">
      <style>{`
        ...
        .mobile-nav-in { animation: slideDown 0.25s ease-out; }
        @media (prefers-reduced-motion: reduce) {
          .float-slow, .steam-1, .steam-2, .steam-3, .pulse-dot, .ticket-stamp, .fade-up, .price-swap, .mobile-nav-in { animation: none !important; }
        }
      `}</style>

      {/* Nav */}
      {/* ← NEW: sticky wrapper + real nav links + mobile menu, logo icon added beside wordmark */}
      <nav className="sticky top-0 z-50 bg-[#1d1a17]/90 backdrop-blur-md border-b border-[#f6efe3]/10">
        <div className="flex items-center justify-between px-4 sm:px-6 py-4 max-w-6xl mx-auto">
          ...
          <div className="hidden md:flex items-center gap-8">
            <button
              ...
              className="text-[#c9c2b4] hover:text-[#e8a33d] text-sm font-semibold transition-colors"
            >
              Features
            </button>
            <button
          ...
          <button
            ...
            className="sm:hidden text-[#f6efe3] p-1"
        ...
        {/* Mobile nav panel */}
        {mobileNavOpen && (
          <div className="sm:hidden mobile-nav-in border-t border-[#f6efe3]/10 px-4 py-4 flex flex-col gap-1">
            <button
              onClick={() => scrollToSection("features")}
              className="text-left text-[#c9c2b4] hover:text-[#e8a33d] text-sm font-semibold py-2.5 transition-colors"
            >
              Features
            </button>
            <button
            ...
            <div className="flex items-center gap-2 pt-3 mt-1 border-t border-[#f6efe3]/10">
              <button
                onClick={() => navigate("/login")}
                className="flex-1 px-4 py-2.5 rounded-full border border-[#f6efe3]/25 text-[#f6efe3] text-sm font-semibold hover:border-[#f6efe3]/50 hover:bg-[#f6efe3]/5 transition-all"
              >
                Login
              </button>
              <button
                onClick={() => navigate("/register")}
                className="flex-1 px-4 py-2.5 rounded-full bg-[#c1440e] hover:bg-[#a83a0c] text-white text-sm font-semibold transition-all"
              >
                Register
              </button>
            </div>
      ...
      {/* Features */}
      <div id="features" className="max-w-6xl mx-auto px-4 sm:px-6 py-14 sm:py-16 border-t border-[#f6efe3]/10 scroll-mt-20">
  ...
  return (
    ...
    >
      ...
      {/* How it works */}
      <div id="how-it-works" className="max-w-4xl mx-auto px-4 sm:px-6 py-14 sm:py-16 scroll-mt-20">
      ...
      {/* Pricing */}
      <div id="pricing" className="max-w-4xl mx-auto px-4 sm:px-6 py-14 sm:py-16 border-t border-[#f6efe3]/10 scroll-mt-20">
        <h2 className="font-display text-2xl sm:text-3xl md:text-4xl text-center mb-3 text-[#f6efe3] font-semibold">
          Simple pricing
        </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mb-12">
            ...
            <div>
              ...
              <div className="space-y-2.5 text-sm">
                ...
                <div className="text-[#8a8378] text-xs">IIT Bombay</div>
                <a
                  href="mailto:ankittkarodiya@gmail.com"
                  className="block text-[#a39c8e] hover:text-[#e8a33d] transition-colors"
                >
                  ankittkarodiya@gmail.com
                </a>
                <a
                  href="tel:+918306762768"
                  className="block text-[#a39c8e] hover:text-[#e8a33d] transition-colors"
                >
                  +91 8306762768
                </a>
