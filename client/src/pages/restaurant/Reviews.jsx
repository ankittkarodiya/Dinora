...
export default function Reviews() {
  ...
  // ← combined into ONE loading check — previously subLoading and the
  // reviews query rendered two separate, sequential loading screens
    ...
    <div className="space-y-6">
      ...
      {totalReviews === 0 ? (
        <div className="rounded-2xl border border-white/10 bg-white/5 p-12 text-center text-slate-400">
          {/* ← replaced the decorative ⭐ emoji with the lucide Star icon */}
          <Star className="w-12 h-12 mx-auto mb-4 text-amber-400" fill="currentColor" />
