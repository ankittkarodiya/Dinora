// the forgot passwor file is not wroking it is just a file and not of any use
...
function VerifyEmail() {
  ...
  const handleSendOtp = async () => {
    if (sendingOtp) return; // prevents double-clicks while already sending
    setSendingOtp(true);
    try {
    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-slate-900 via-slate-800 to-slate-700 px-4">
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-white/10 backdrop-blur-xl p-8 shadow-2xl">
        ...
        <button
          ...
          disabled={sendingOtp}
          className="w-full rounded-xl bg-green-600 py-3 font-semibold text-white transition-all duration-300 hover:bg-green-700 mb-5 disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <form onSubmit={handleVerifyOtp} className="space-y-5">
          ...
          <button
            ...
            className="w-full rounded-xl bg-blue-600 py-3 font-semibold text-white transition-all duration-300 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
